        ...
        <div class="col-lg-4 order-lg-2">
            ...
            <div class="card shadow mb-4">
                <div class="card-profile-image mt-4">
                    @if (Auth::user()->photo)
                        <img src="{{ asset('storage/' . Auth::user()->photo) }}" alt="User Photo" class="rounded-circle"
                    ...
                    <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data"
                        ...
                        <div class="pl-lg-4">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="last_name">Nama Balakang</label>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="form-control-label" for="photo">Profile Photo</label>
