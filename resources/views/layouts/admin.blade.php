    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('home') }}">
                ...
                <div class="sidebar-brand-text mx-3">Donat Gacor : ><sup></sup></div>
            </a>
            ...
            <!-- Donat / Produk -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('donat.index') }}">
                            ...
                            <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="userDropdown"
                                ...
                                @if(Auth::user()->photo)
                                    <img class="img-profile rounded-circle ml-2"
                                         src="{{ asset('storage/' . Auth::user()->photo) }}" alt="User Photo" width="36"
            ...
            <footer class="sticky-footer bg-white mt-auto">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>@2040 SARI JADI PRESIDEN</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
